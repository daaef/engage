...
export const Logo = (props)=>{
  return (
    <svg height={props.height} width={props.width} viewBox="0 0 212 32" xmlns="http://www.w3.org/2000/svg">
      <title>engage dark logo</title>
      <g fill="none">
        ...
        <path className="dark--one" d="M4.911 1.33h25.17v4.297H0L4.911 1.33z" fill="#F8A900"/>
        <path className="dark--one" d="M4.945 31.616h25.34v-4.502H0l4.945 4.502z" fill="#F8A900"/>
        <path className="dark--one" d="M0 18.519h30.286v-4.502H0v4.502z" fill="#F8A900"/>
